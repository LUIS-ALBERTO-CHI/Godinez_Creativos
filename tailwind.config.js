  ...
  theme: {
    extend: {
      colors: {
        ...
        'surface-tint': '#f60566',
        'secondary-fixed': '#121212',
        'surface-container-highest': '#4d4d4d',
        'primary-fixed-dim': '#f60566',
        'surface-bright': '#3a3939',
        'on-surface': '#f8fafc',
        'on-primary-fixed-variant': '#f60566',
        'outline-variant': '#4a4455',
        'on-tertiary': '#ffffff',
        'on-tertiary-fixed-variant': '#2D2D2D',
        'surface': '#121212',
        'inverse-on-surface': '#313030',
        'primary': '#f60566',
        'secondary': '#121212',
        'on-surface-variant': '#94A3B8',
        'on-tertiary-fixed': '#2D2D2D',
        'background': '#0e0e0e',
        'primary-fixed': '#f60566',
        'primary-container': '#f60566',
        'surface-container-low': '#181818',
        'on-error-container': '#ffdad6',
        'on-background': '#f8fafc',
        'tertiary-container': '#2D2D2D',
        'on-secondary-fixed-variant': '#121212',
        'tertiary': '#2D2D2D',
        'on-secondary': '#ffffff',
        'surface-container': '#2D2D2D',
        'on-secondary-container': '#f8fafc',
        'inverse-primary': '#f60566',
